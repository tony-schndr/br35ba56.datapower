...
class TestDPManageConfigSchema:
    ...
    def test_DPManageConfigSchema_get_prop_1(self):   
        dp_schema = load_schema('CryptoValCred')
    ...
    def test_DPManageConfigSchema_get_prop_2(self):
        dp_schema = load_schema('AAAPolicy')
    ...
    def test_DPManageConfigSchema_get_is_valid_param_8(self):
        dp_schema = load_schema('EthernetInterface')
    ...
    '''
    def test_DPManageConfigSchema_is_valid_param_valcred(self):
        valcred =  {
                "CryptoValCred": {
        ...
        for k, v in valcred['CryptoValCred'].items():
            schema = load_schema('CryptoValCred')
            assert schema.is_valid_param(k,v)
    '''