...
DOCUMENTATION = r'''
---
module: backup_domains

short_description: Backup (export) DataPower application domains from backup.

version_added: "1.0.0"

description: |
    Backup (export) DataPower application domains.
    This is not a secure backup.
